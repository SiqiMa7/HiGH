...
from mhgcn_douban_movie import MHGCN_douban
...
def main(args):
    ...
    for cross_id in range(args.cross_num):
        ...
        model = MHGCN_douban(struct_feat.size(1)+30, args.hidden, args.out, args.dropout, loss_fcn)
        ...
        for epoch in range(args.epochs):
            ...
            if args.early_stop:
                if args.spm:
                    ...
                    stop = stopper.step(test_spm, epoch, model)
                else:
            ...
            if epoch == 99:
                ...
                elapsed_100 = time.time() - hundred_start_time
                print(f"First 100 epochs wall time(s): {elapsed_100:.4f}")
...
if __name__ == '__main__':
    ...
    parser.add_argument("--dataset", type=str, default='doubanmovie_rel.pk',
