...
from .metric import ndcg, spearman_sci, median_AE
import pdb
...
def load_fb15k_rel_data(data_path, cross_validation_shift=0, dataset_name='FB15k_rel'):
    ...
    if 'semantic' in dataset_name:
        ...
        node_feat1 = data['features']
        node_feat2 = pickle.load(open('/home/msq/PycharmProjects/RGTN-NIE-main/datasets/fb_lang.pk', 'rb'))
        node_feat2 = torch.from_numpy(node_feat2).float()
    else:
...
def load_tmdb_rel_data(data_path, cross_validation_shift=0, dataset_name='TMDB_rel'):
    ...
    if 'semantic' in dataset_name:
        ...
        node_feat1 = data['features']
        node_feat2 = pickle.load(open('/home/msq/PycharmProjects/RGTN-NIE-main/datasets/tmdb_lang.pk', 'rb'))
        node_feat2 = torch.from_numpy(node_feat2).float()
    elif 'concat' in dataset_name:
        node_feat1 = data['features']
...
def load_ga16k_rel_data(data_path, cross_validation_shift=0, dataset_name='GA16k_rel'):
    ...
    if 'semantic' in dataset_name:
        ...
        node_feat1 = data['features']
        node_feat2 = pickle.load(open('/home/msq/PycharmProjects/RGTN-NIE-main/datasets/ga_lang.pk', 'rb'))
        node_feat2 = torch.from_numpy(node_feat2).float()
    else:
        node_feats = data['features']
...
def load_movielen_rel_data(data_path, cross_validation_shift=0, dataset_name='movielen_rel'):
    """
    load ga16k data
    :param data_path: str, data file path
    :param cross_validation_shift: int, shift of data split
    ...
    node_feat1 = data['features'].float()
    ...
    # # log transform for labels
    labels = torch.log(1 + labels)
    all_indices = np.arange(g.number_of_nodes())
    # Calculate split sizes
    train_size = int(0.7 * g.number_of_nodes())
    val_size = int(0.1 * g.number_of_nodes())
    test_size = g.number_of_nodes() - train_size - val_size  # Ensures all indices are used
    ...
    # Convert indices to PyTorch tensors if needed
    ...
    # if 'two' in dataset_name:
    #     return hg, edge_types, edge_norm, rel_num, node_feat1, node_feat2, labels, train_idx, val_idx, test_idx, edges
    return hg, edge_types, edge_norm, rel_num, node_feat1, node_feat1, labels, train_idx, val_idx, test_idx

def load_doubanmovie_rel_data(data_path, cross_validation_shift=0, dataset_name='doubanmovie_rel'):
    """
    load ga16k data
    :param data_path: str, data file path
    :param cross_validation_shift: int, shift of data split
...
def load_doubanbook_rel_data(data_path, cross_validation_shift=0, dataset_name='doubanmovie_rel'):
    """
    load ga16k data
    :param data_path: str, data file path
    :param cross_validation_shift: int, shift of data split
...
def load_data(data_path, dataset_name, cross_validation_shift=0):
    ...
    elif dataset_name.startswith('movielen'):
        return load_movielen_rel_data(data_path, cross_validation_shift, dataset_name)
    elif dataset_name.startswith('doubanmovie'):
        return load_doubanmovie_rel_data(data_path, cross_validation_shift, dataset_name)
    elif dataset_name.startswith('doubanbook'):
        return load_doubanbook_rel_data(data_path, cross_validation_shift, dataset_name)
    else:
